...
#> Set General Parameters for Configuring the Simulation
 set VRSN      = v533_ISAM              #> Code Version - note this must be updated if using ISAM or DDM
...
#> Set Working, Input, and Output Directories
 ...
 setenv OUTDIR  ${CMAQ_DATA}/output_CCTM_${APPL}  #> Output Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2023-03-21"     #> beginning date
 set END_DATE   = "2023-04-30"     #> ending date 
...
# setenv GRIDDESC ${CMAQ_DATA}/met/mcip/${GRID_NAME}/2020178/GRIDDESC    #> grid description file
 setenv GRIDDESC $CMAQ_DATA/met/mcip/${GRID_NAME}/2023021/GRIDDESC
...
#> Output Species and Layer Options
  ...
  #  setenv ACONC_BLEV_ELEV " 1 1" #> ACONC file layer range; comment to write all layers to ACONC
   setenv AVG_FILE_ENDTIME Y     #> override default beginning ACONC timestamp [ default: N ]
...
# setenv CTM_PT3DEMIS N        # Revised by Yiming Liu
#                              #>    [ default: N ]
...
#> from v521
set EMISpath  = $INPDIR/emis           # Revised by Yiming Liu
...
# =====================================================================
  ...
  ./run_${GRID_NAME}.emis >& emis.log
  cd ../../CCTM/scripts

  #> Initial conditions
  if ($NEW_START == true || $NEW_START == TRUE ) then
   #   setenv ICFILE ICON_20160630_bench.nc
     setenv ICFILE ICON_v533_${GRID_NAME}_profile
...
#   set BCFILE = bc.${GRID_NAME}.cmaq.${MECH}.${YYYYMMDD}.ncf # Revised by Yiming Liu
  set BCFILE = BCON_v533_${GRID_NAME}_regrid_${YYYYMMDD}    # Revised by Yiming Liu
  ...
  setenv GRID_BDY_2D $METpath/${GRID_NAME}/${YYYYJJJ}/GRIDBDY2D_${YYYYJJJ}.nc  # GRID files are static, not day-specific
  setenv GRID_CRO_2D $METpath/${GRID_NAME}/${YYYYJJJ}/GRIDCRO2D_${YYYYJJJ}.nc
  setenv GRID_CRO_3D $METpath/${GRID_NAME}/${YYYYJJJ}/GRIDCRO3D_${YYYYJJJ}.nc
  setenv GRID_DOT_2D $METpath/${GRID_NAME}/${YYYYJJJ}/GRIDDOT2D_${YYYYJJJ}.nc
  setenv MET_CRO_2D $METpath/${GRID_NAME}/${YYYYJJJ}/METCRO2D_${YYYYJJJ}.nc
  setenv MET_CRO_3D $METpath/${GRID_NAME}/${YYYYJJJ}/METCRO3D_${YYYYJJJ}.nc
  setenv MET_DOT_3D $METpath/${GRID_NAME}/${YYYYJJJ}/METDOT3D_${YYYYJJJ}.nc
  setenv MET_BDY_3D $METpath/${GRID_NAME}/${YYYYJJJ}/METBDY3D_${YYYYJJJ}.nc
  setenv LUFRAC_CRO $METpath/${GRID_NAME}/${YYYYJJJ}/LUFRAC_CRO_${YYYYJJJ}.nc
   #>from v521
...
# new
  ...
  setenv CMAQ_MASKS $SZpath/ocean.${GRID_NAME}.ncf #> horizontal grid-dependent surf zone file

  #> Gridded Emissions Files 
  setenv N_EMIS_GR 7
#   set EMISfile  = emis_mole_all_${YYYYMMDD}_cb6_bench.nc
   # set EMISfile  = emis.${GRID_NAME}.ncf    # Revised by Yiming Liu 
  setenv GR_EMIS_001 ${EMISpath}/emis_pow.${GRID_NAME}.ncf
  ...
  setenv GR_EMIS_002 ${EMISpath}/emis_ind.${GRID_NAME}.ncf
  ...
  setenv GR_EMIS_003 ${EMISpath}/emis_res.${GRID_NAME}.ncf
  ...
  setenv GR_EMIS_004 ${EMISpath}/emis_tra.${GRID_NAME}.ncf
  setenv GR_EMIS_LAB_004 MEIC_TRA
  setenv GR_EM_SYM_DATE_004 F # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  setenv GR_EMIS_005 ${EMISpath}/emis_agr.${GRID_NAME}.ncf
  setenv GR_EMIS_LAB_005 MEIC_AGR
  setenv GR_EM_SYM_DATE_005 F # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  setenv GR_EMIS_006 ${EMISpath}/emis_shp.${GRID_NAME}.ncf
  setenv GR_EMIS_LAB_006 MEIC_SHP
  setenv GR_EM_SYM_DATE_006 F # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  setenv GR_EMIS_007 ${EMISpath}/emis_bio.${GRID_NAME}.ncf
  setenv GR_EMIS_LAB_007 MEIC_BIO
  setenv GR_EM_SYM_DATE_007 F # To change default behaviour please see Users Guide for EMIS_SYM_DATE
...
#   setenv OCEAN_1 $SZpath/12US1_surf_bench.nc #> horizontal grid-dependent surf zone file
  setenv OCEAN_1 $SZpath/ocean.${GRID_NAME}.ncf    # Revised by Yiming Liu
...
#       setenv PA_BLEV_ELEV "1  4"   # default: all levels
      ...
      #   setenv PA_BCOL_ECOL "1 98"
      #   setenv PA_BROW_EROW "1 74"
      #   setenv PA_BLEV_ELEV "1 20"
...
# ===================================================================
  ...
  ( time yhrun -n $NPROCS $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
#   yhrun -N 10 -n $NPROCS $BLD/$EXEC
